  ...
  return {
    ...
    render() {
      return `
        ...
        <main>
          <section id="home" class="hero">
            <div class="hero-content">
              <h2>Selamat Datang di Toko Kue Manis</h2>
              <p>Toko kue dan roti segar dengan cita rasa tradisional Indonesia</p>
          ...
          <section id="about" class="about">
            <div class="container">
              <h2>Tentang Kami</h2>
              <p>Kami adalah Bakery terpercaya yang melayani dengan sepenuh hati.</p>
            </div>
          </section>
          ...
          <section id="contact" class="contact">
            <div class="container">
              ...
              <div class="contact-info">
                ...
                <p>📧 Email: info@tokokuemanis.com</p>
        ...
        <footer class="footer">
          <div class="container">
            <p>&copy; 2025 Toko Kue Manis. Dibuat dengan ❤️ oleh NYAI</p>
          </div>
        </footer>
      `
    },
